...
// show nav dropdown and notifications dropdown.	
...
$(".strengthify-header").on('click', function() {
	...
	$(".strengthify-header-dropdown-li-item").each(function() {
...
$(document).ready(function () {	
	...
	var margin = {top: 0, right: 0, bottom: 20, left: 00};
	var view = "Profile"; 

	if ($(".workouts_graph").length == 1) { draw(500, 100, margin, 45, user_id, view);}
}); 
$(document).ready(function() {	
	...
	if ($("#tabContainer").length == 1) { draw(900, 360, margin, 25, user_id, view); }		
}); 
$(document).ready(function() {
